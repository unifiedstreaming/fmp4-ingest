...
13.	In case fixed length POST Commands are used, the live source entity MAY resend the segment to be posted decribed in the manifest entirely in case of responses HTTP 400, 412. 
